...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $users_id2 = $_POST['users_id2'];
    $Lucky_number2 = $_POST['Lucky_number2'];
    $Name2 = $_POST['Name2'];
    $message2 = $_POST['message2'];

    // Check if Lucky Number is already owned
    $check_sql = "SELECT * FROM user_entry_silver2 WHERE Lucky_number2 = '$Lucky_number2'";
    ...
    $count_sql = "SELECT COUNT(*) as count FROM user_entry_silver2  WHERE users_id2 = '$users_id2'";
    ...
    $sql = "INSERT INTO user_entry_silver2  (users_id2, Lucky_number2, Name2, message2) 
            VALUES ('$users_id2','$Lucky_number2','$Name2','$message2')";
    ...
    if ($conn->query($sql) === TRUE) {
        ...
        session_start();
        $_SESSION['id'] = $id;
        header("Location: silver_raf3.php");
        exit();
    } else {
...
$sql = "SELECT * FROM user_entry_silver2";
...
<table class="table1" >
		...
		<?php
$seq = 1;
while ($user_entry2 = mysqli_fetch_assoc($result)) {
       echo "<tr>";
			
    echo "<td>".$user_entry2['users_id2']."</td>";
 
    echo "<td>".$user_entry2['Name2']."</td>";
       echo "<td>".$user_entry2['Lucky_number2']."</td>";
    echo "<td>".$user_entry2['message2']."</td>";
...
<form action="silver_raf3.php" method="post" id="myForm" style="display: none;">
<section id="name-input-container">
 

<input name="users_id2" type="int" readonly value="<?php echo $user_id;?>"> <br><br>

<input name="Name2" type="text" readonly   value="<?php echo $name;?>"> <br><br>
<input name="Lucky_number2" type="text" placeholder="Enter your Lucky Number"> <br><br>
<textarea name="message2" placeholder="Any Message to the Developer?"></textarea> <br><br>
...
document.getElementById("s-ent").addEventListener("click", function() {
    ...
    if (silverBalance >= 1 && !hasLuckyNumber) {
        ...
        xhr.open("POST", "s2_update_balance.php", true);
...
<section id="winner-history">
      ...
      <table id="winner-history-table"  class="table2"  style="width:100%; ">
        ...
        <?php
        $seq = 1;
        while ($s3_winner = mysqli_fetch_assoc($result)) {
          echo "<tr>";
          echo "<td>" . $s3_winner['users_id_s3'] . "</td>";
          echo "<td>" . $s3_winner['Name_s3'] . "</td>";
          echo "<td>" . $s3_winner['Date_s3'] . "</td>";
          echo "</tr>";
          $seq += 1;
        }
        ?>
