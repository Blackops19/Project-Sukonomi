...
if (!isset($_SESSION['admin_id'])) {
 ...
 include 'process/dbh.php';
    ...
    $sql = "SELECT name FROM alogin WHERE Admin_id='$admin_id'";
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<script>alert('Error fetching uadmin information!');</script>";
        exit();
    }
            ...
            <div class="card card-1">
                ...
                <div class="card-body">
                    ...
                    <form action="process/addempprocess.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="Bussiness Location" name="location" >
                        </div>
                        ...
                        <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="Click Counts" name="click_count">
                        </div>
