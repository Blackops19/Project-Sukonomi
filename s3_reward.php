...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    // Get the form data
    $users_id_s3 = $_POST['users_id_s3'];
    $Name_s3 = $_POST['Name_s3'];
    $Date_s3 = $_POST['Date_s3']; // New field

    // Create the SQL query to insert the data into the database
    $sql = "INSERT INTO s3_winner (users_id_s3, Name_s3, Date_s3) 
            VALUES ('$users_id_s3', '$Name_s3', '$Date_s3')";
